<template>
  <div v-loading="loading">
    <el-form ref="jurisdiction" :model="jurisdiction" label-width="90px" class="jurisdiction">
      <el-form-item label="语音限制:"><el-input v-model="jurisdiction.day" placeholder="限制请输入天数，输0设为正常" /></el-form-item>
      <el-form-item label="当前:">{{ jurisdictData.system_voice_limit }}</el-form-item>
