  ...
  <div v-loading="loading">
    <el-row :gutter="20">
      <el-col v-for="(item, index) in albumData" :key="index" :xs="24" :sm="24" :md="12" :lg="8" :xl="6">
        <div>
          <video style="width: 100%;height: 250px;" :src="item.attachment_id" :preview-src-list="srcList" :poster="item.video_cover" controls="true" />
          <div>
    ...
    <div v-if="albumData.length == 0" class="noVideo">暂无数据</div>
  </div>
</template>
